...
def calculate_score(m1, m2, verbose=True):
    '''
...
print("Load predictions matrix from file...")
...
train_rmse = calculate_score(train_mat, preds)
print("RMSE on training set: " + str(train_rmse))
test_rmse = calculate_score(test_mat, preds)
